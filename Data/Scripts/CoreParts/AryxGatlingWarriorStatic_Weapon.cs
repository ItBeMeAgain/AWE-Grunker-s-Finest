...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition AryxFixedWarriorGatling => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ARYXWarriorGatlingGun",
            ...
            HardPoint = new HardPointDef
            {
                ...
                HardWare = new HardwareDef
                {
                    ...
                    Offset = Vector(x: 0, y: 0.5, z: 0), // Offsets the aiming/firing line of the weapon, in metres.
            ...
            Animations = AryxStaticWarriorAnimations,
